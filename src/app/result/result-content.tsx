...
// Client components for /result — split so page.tsx can be a server component with metadata.
// ResultContent uses useSearchParams + useRouter; must stay client.
  ...
  return (
    <main className="min-h-screen">
      <div className="mx-auto max-w-xl px-6 py-16">
        {/* Back nav — button, not Link, so it goes to the actual previous page */}
        <button
          onClick={() => router.back()}
...
export default function ResultContentWrapper() {
  return (
    <Suspense>
      <ResultContent />
    </Suspense>
